...
const RoadmapPhase1 = () => {
  ...
  return (
    <div className=" min-h-screen flex flex-col items-center justify-center">
      <h1 className="roadmap01-h1 text-white text-5xl sm:text-4xl md:text-5xl  mb-6">
        Roadmap
      </h1>
      <div className="flex flex-col lg:flex-row items-center lg:space-x-10 gap-10 w-full mt-10">
        <div className="text-Area flex flex-col items-center w-full lg:w-1/3 lg:ml-44">
          <h1 className="roadmap01-h2 text-white text-3xl sm:text-4xl md:text-5xl head-gradient mb-8">
            PHASE 1
          </h1>
        ...
        >
          <img
            src={phase1}
            alt="Roadmap"
            className="w-[80vw] sm:w-[70vw] md:w-[60vw] lg:w-[48vw] h-auto"
          />
        </div>
      </div>
    </div>
