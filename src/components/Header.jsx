...
export const Header = () => {
  return (
    <div className="mx-auto w-full relative overflow-hidden header">
      <Navbar />
      <div className="md:flex p-14 mt-20">
        <header className="md:w-[50%] md:ml-32 mt-20">
          ...
          <button className="bg-gradient-to-r from-indigo-500 to-pink-500 rounded-md py-4 px-8 border-0 mt-9 hover:from-indigo-700 hover:to-pink-700">
            Get Started
          </button>
        </header>
